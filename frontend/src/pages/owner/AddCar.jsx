...
const AddCar = () => {
    ...
    return (
        <div className='px-4 py-10 md:px-10 flex-1'>
            ...
            <Title title='Add new car' subTitle="Fill in details to list a car" />
            ...
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    <div className='flex flex-col w-full'>
                        <label>Brand</label>
                        <input type="text" placeholder='e.g. TATA,Mahindra,Maruti,Kia...' required
                            className='px-3 py-2 mt-1 border-borderColor rounded-md outline-1'
                            value={car.brand} onChange={e => setCar({ ...car, brand: e.target.value })} />
                    </div>

                    <div className='flex flex-col w-full'>
                        <label>Model</label>
                        <input type="text" placeholder='e.g. Punch,Thar,Baleno,Scorpio,Bolero...' required
                            className='px-3 py-2 mt-1 border-borderColor rounded-md outline-1'
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <select onChange={e => setCar({ ...car, category: e.target.value })}
                            value={car.category}
                            className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-1'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <select onChange={e => setCar({ ...car, location: e.target.value })}
                            ...
                            <option value="Petrol">Mumbai</option>
                            <option value="Diesel">Banglore</option>
                            <option value="PETROL+CNG">Patna</option>
                            <option value="Charge">Dhanbad</option>
                        </select>
                    </div>
                </div>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <textarea rows={5} placeholder='e.g. A luxurious SUV with spacious interior...' required
                        className='px-3 py-2 mt-1 border-borderColor rounded-md outline-1'
