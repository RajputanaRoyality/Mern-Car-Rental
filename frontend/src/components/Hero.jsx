...
const Hero = () => {
    ...
    return (
        <div className='h-screen flex flex-col items-center justify-center gap-14 bg-sky-50 text-center'>
        ...
        bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
                ...
                <button className='flex flex-row justify-center items-center gap-1 px-8 py-3 mr-6 sm:mt-5
